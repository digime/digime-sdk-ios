Pod::Spec.new do |s|
  ...
  s.source_files  	= "DigiMeSDK/Callbacks/*.{h,m}", "DigiMeSDK/Core/*.{h,m}", "DigiMeSDK/Entities/*.{h,m}", "DigiMeSDK/Errors/*.{h,m}", "DigiMeSDK/Network/*.{h,m}", "DigiMeSDK/Security/*.{h,m}", "DigiMeSDK/Utility/*.{h,m}"
