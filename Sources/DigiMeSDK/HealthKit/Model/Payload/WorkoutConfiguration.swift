...
public struct WorkoutConfiguration: Codable {
    ...
    public static func make(from dictionary: [String: Any]) throws -> WorkoutConfiguration {
        guard
			...
			throw SDKError.invalidValue(
				message: "Invalid dictionary: \(dictionary)"
            )
        }
		
		return WorkoutConfiguration(activityValue: activityValue,
									locationValue: locationValue,
									swimmingValue: swimmingValue,
									harmonized: try Harmonized.make(from: harmonized))
    }

	public init(activityValue: Int,
				locationValue: Int,
				swimmingValue: Int,
...
extension WorkoutConfiguration.Harmonized: Payload {
    public static func make(from dictionary: [String: Any]) throws -> WorkoutConfiguration.Harmonized {
        guard
        ...
        return WorkoutConfiguration.Harmonized(value: Double(truncating: value), unit: unit)
    }
}
