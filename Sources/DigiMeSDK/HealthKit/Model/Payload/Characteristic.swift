...
public struct Characteristic: Codable {
    ...
    init(biologicalSex: HKBiologicalSexObject?, bloodType: HKBloodTypeObject?, fitzpatrickSkinType: HKFitzpatrickSkinTypeObject?) {
	...
	init(biologicalSex: HKBiologicalSexObject?,
