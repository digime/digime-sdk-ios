...
public struct WorkoutRoute: PayloadIdentifiable, Sample {
    ...
    public struct Harmonized: Codable {
		...
		public init(count: Int, routes: [Route], metadata: Metadata?) {
            self.count = count
            self.routes = routes
            self.metadata = metadata
        }

		public func copyWith(count: Int? = nil, routes: [Route]? = nil, metadata: Metadata? = nil) -> Harmonized {
...
extension WorkoutRoute.Location: Payload {
	public static func make(from dictionary: [String: Any]) throws -> WorkoutRoute.Location {
		guard
			...
			let verticalAccuracy = dictionary["verticalAccuracy"] as? NSNumber else {
		...
		return WorkoutRoute.Location(latitude: Double(truncating: latitude),
...
extension WorkoutRoute: Payload {
	public static func make(from dictionary: [String: Any]) throws -> WorkoutRoute {
		...
		return WorkoutRoute(identifier: identifier,
...
extension WorkoutRoute.Harmonized: Payload {
    public static func make(from dictionary: [String: Any]) throws -> WorkoutRoute.Harmonized {
        ...
        return WorkoutRoute.Harmonized(count: count, routes: try WorkoutRoute.Route.collect(from: routes), metadata: metadata?.asMetadata)
    }
}
...
extension WorkoutRoute.Route: Payload {
    public static func make(from dictionary: [String: Any]) throws -> WorkoutRoute.Route {
        ...
        return WorkoutRoute.Route(locations: try WorkoutRoute.Location.collect(from: locations), done: done)
    }
