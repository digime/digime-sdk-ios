...
extension Electrocardiogram.Harmonized: Payload {
	public static func make(from dictionary: [String: Any]) throws -> Electrocardiogram.Harmonized {
		...
		return Electrocardiogram.Harmonized(averageHeartRate: averageHeartRate != nil
    ...
    static func collect(results: [HKSample]) -> [Electrocardiogram] {
        ...
        if let electrocardiograms = results as? [HKElectrocardiogram] {
            for electrocardiogram in electrocardiograms {
                do {
                    let sample = try Electrocardiogram(electrocardiogram: electrocardiogram, voltageMeasurements: [])
...
extension Electrocardiogram: Payload {
	public static func make(from dictionary: [String: Any]) throws -> Electrocardiogram {
		...
		return Electrocardiogram(identifier: identifier,
...
extension Electrocardiogram.VoltageMeasurement: Payload {
    public static func make(from dictionary: [String: Any]) throws -> Electrocardiogram.VoltageMeasurement {
        guard
            ...
            let timeSinceSampleStart = dictionary["timeSinceSampleStart"] as? NSNumber else {
			
			throw SDKError.invalidValue(message: "Invalid dictionary: \(dictionary)")
        }
        return Electrocardiogram.VoltageMeasurement(harmonized: try Electrocardiogram.VoltageMeasurement.Harmonized.make(from: harmonized), timeSinceSampleStart: Double(truncating: timeSinceSampleStart))
    }
...
extension Electrocardiogram.VoltageMeasurement.Harmonized: Payload {
    public static func make(from dictionary: [String: Any]) throws -> Electrocardiogram.VoltageMeasurement.Harmonized {
        guard
        ...
        return Electrocardiogram.VoltageMeasurement.Harmonized(value: Double(truncating: value), unit: unit)
    }
}
