...
public struct Device: Codable {
	...
	public func copyWith(name: String? = nil,
						 ...
						 udiDeviceIdentifier: String? = nil) -> Device {
		return Device(name: name ?? self.name,
...
extension Device: Payload {
	public static func make(from dictionary: [String: Any]) throws -> Device {
		return Device(name: dictionary["name"] as? String,
