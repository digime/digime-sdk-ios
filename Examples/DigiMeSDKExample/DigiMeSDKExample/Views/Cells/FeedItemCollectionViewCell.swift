...
class DataTypeCollectionViewCell: UICollectionViewCell {
    ...
    func updateChartView(with values: [FitnessActivitySummary]) {
        ...
        chartView.graphView.dataSeries = [
            OCKDataSeries(values: steps, title: "steps", color: .systemBlue),
            OCKDataSeries(values: distance, title: "meter", color: .systemGreen),
            OCKDataSeries(values: energy, title: "kcal", color: .systemRed),
        ]
    }
