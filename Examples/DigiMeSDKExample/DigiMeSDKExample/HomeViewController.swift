...
//
//        let config = DigiMeSDK.Configuration(appId: appId, contractId: contractId, privateKey: privateKey)
//
//        let limits = Limits(duration: 9)
//        sdk = DigiMe(configuration: config)
//        sdk?.authorize(readOptions: nil) { _ in
////            self.sdk?.readAccounts { result in
////
////            }
//            
//            self.sdk?.readFiles(readOptions: nil, downloadHandler: { result in
