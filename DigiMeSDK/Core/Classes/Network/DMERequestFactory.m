...
- (NSURLRequest *)dataPushWithPostboxId:(NSString *)postboxId dataToPush:(NSData *)data headerParameters:(NSDictionary *)headers
{
                              ...
                              file:(NSData *)data
{
    ...
    NSString *mimetype = @"application/json";//[self mimeTypeForPath:path];
