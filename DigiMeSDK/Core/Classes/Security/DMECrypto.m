...
+ (NSString *)createCyclicCAPreauthorizationCodeWithAppId:(NSString *)appId contractId:(NSString *)contractId publicKey:(NSString *)publicKeyHexString privateKey:(NSString *)privateKeyHexString
{
    ...
    NSString *preauthorisationJWT = [[DMEJWTManager new] createAndSignPreAuthToken:appId contractId:contractId publicKeyBase64:publicKeyBase64 privateKeyBase64:privateKeyBase64];
    NSAssert(preauthorisationJWT != nil, @"Cyclic CA. An error occured generating pre-auth jwt token");
...
+ (NSString *)validateAndDecodeCyclicCAPreauthorizationCodeWithAuthorityPublicKeyPem:(NSString *)authorityPublicKeyPem preauthToken:(NSString *)preauthToken
{
    ...
    NSAssert(validatedJWT != nil, @"Cyclic CA. An error occured validating pre-auth jwt token");
    return validatedJWT;
}
...
+ (NSString *)createCyclicCAAuthorizationCodeWithAuthCode:(NSString *)authCode appId:(NSString *)appId contractId:(NSString *)contractId publicKey:(NSString *)publicKeyHexString privateKey:(NSString *)privateKeyHexString
{
    ...
    NSData *privateKeyData = [privateKeyHexString hexToBytes];
    NSString *privateKeyBase64 = [privateKeyData base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];
    NSString *authorisationJWT = [[DMEJWTManager new] createAndSignAuthToken:authCode appId:appId contractId:contractId publicKeyBase64:publicKeyBase64 privateKeyBase64:privateKeyBase64];
    NSAssert(authorisationJWT != nil, @"Cyclic CA. An error occured generating auth jwt token");
