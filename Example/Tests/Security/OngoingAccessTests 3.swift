...
class OngoingAccessTests: XCTestCase {
    struct Keys {
    ...
    override func setUp() {
        guard
            let assetsPath = Bundle(for: type(of: self)).path(forResource: "OngoingAccessTestingAssets", ofType: "plist"),
